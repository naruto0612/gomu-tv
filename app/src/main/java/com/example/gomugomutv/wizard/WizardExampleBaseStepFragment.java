...
package com.example.gomugomutv.wizard;

import android.os.Bundle;

import androidx.leanback.app.GuidedStepFragment;

import com.example.gomugomutv.DetailsActivity;
import com.example.gomugomutv.Movie;
import com.example.gomugomutv.R;
...
public abstract class WizardExampleBaseStepFragment extends GuidedStepFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        mMovie = (Movie) getArguments().getSerializable(DetailsActivity.MOVIE);
