...
//        Log.d("cursorView123_", "dispatchKeyEvent " + keyEvent);
        Callback callback2 = this.callback;
        if (callback2 != null) {
            callback2.onUserInteraction();
        }
...
//        KeyEvent.KEYCODE_BACK: 4
        ...
        if (!isCursorDissappear()) {
            if (keyEvent.getAction() == 0 && !getKeyDispatcherState().isTracking(keyEvent) && keyCode == KeyEvent.KEYCODE_DPAD_CENTER) {
...
//        Log.d("cursorView123_", "dispatchDraw");
